        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  class="active-menu"  href="meals.php"><i class="fa fa-plus-circle"></i>Add meals</a>
                    </li>
						...
						<form name="form" method="post">
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										$check="SELECT * FROM meals";
										$rs = mysqli_query($con,$check);
										$data = mysqli_fetch_array($rs, MYSQLI_NUM);
                                            $sql ="INSERT INTO `meals`( `type`, `price`) VALUES ('$meal','$price')" ;
                                            if(mysqli_query($con,$sql))
                                            {
                                            echo '<script>alert("New Meal Added") </script>' ;
                                            }else {
